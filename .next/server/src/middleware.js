...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=C%3A%5CUsers%5CCarlos%5Csl%C3%B1al&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2Rhc2hib2FyZCg%2FOlxcLygoPzpbXlxcLyNcXD9dKz8pKD86XFwvKD86W15cXC8jXFw%2FXSs%2FKSkqKSk%2FKC5qc29uKT9bXFwvI1xcP10%2FJCIsIm9yaWdpbmFsU291cmNlIjoiL2Rhc2hib2FyZC86cGF0aCoifV0%3D&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2Rhc2hib2FyZCg%2FOlxcLygoPzpbXlxcLyNcXD9dKz8pKD86XFwvKD86W15cXC8jXFw%2FXSs%2FKSkqKSk%2FKC5qc29uKT9bXFwvI1xcP10%2FJCIsIm9yaWdpbmFsU291cmNlIjoiL2Rhc2hib2FyZC86cGF0aCoifV19!
...
var supabase;
function createClientComponentClient({ supabaseUrl = "https://qdinmvlhendpkjimagnq.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFkaW5tdmxoZW5kcGtqaW1hZ25xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUzNTAzNjQsImV4cCI6MjA2MDkyNjM2NH0.3uafMgdT5Ie0DvzGyy2owt7lBK54BHLU7AfNY9n74mo", options, cookieOptions, isSingleton = true } = {}) {
...
function createPagesServerClient(context, { supabaseUrl = "https://qdinmvlhendpkjimagnq.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFkaW5tdmxoZW5kcGtqaW1hZ25xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUzNTAzNjQsImV4cCI6MjA2MDkyNjM2NH0.3uafMgdT5Ie0DvzGyy2owt7lBK54BHLU7AfNY9n74mo", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createMiddlewareClient(context, { supabaseUrl = "https://qdinmvlhendpkjimagnq.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFkaW5tdmxoZW5kcGtqaW1hZ25xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUzNTAzNjQsImV4cCI6MjA2MDkyNjM2NH0.3uafMgdT5Ie0DvzGyy2owt7lBK54BHLU7AfNY9n74mo", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createServerComponentClient(context, { supabaseUrl = "https://qdinmvlhendpkjimagnq.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFkaW5tdmxoZW5kcGtqaW1hZ25xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUzNTAzNjQsImV4cCI6MjA2MDkyNjM2NH0.3uafMgdT5Ie0DvzGyy2owt7lBK54BHLU7AfNY9n74mo", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createRouteHandlerClient(context, { supabaseUrl = "https://qdinmvlhendpkjimagnq.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFkaW5tdmxoZW5kcGtqaW1hZ25xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUzNTAzNjQsImV4cCI6MjA2MDkyNjM2NH0.3uafMgdT5Ie0DvzGyy2owt7lBK54BHLU7AfNY9n74mo", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = "https://qdinmvlhendpkjimagnq.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFkaW5tdmxoZW5kcGtqaW1hZ25xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUzNTAzNjQsImV4cCI6MjA2MDkyNjM2NH0.3uafMgdT5Ie0DvzGyy2owt7lBK54BHLU7AfNY9n74mo", options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = "https://qdinmvlhendpkjimagnq.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFkaW5tdmxoZW5kcGtqaW1hZ25xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUzNTAzNjQsImV4cCI6MjA2MDkyNjM2NH0.3uafMgdT5Ie0DvzGyy2owt7lBK54BHLU7AfNY9n74mo", options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = "https://qdinmvlhendpkjimagnq.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFkaW5tdmxoZW5kcGtqaW1hZ25xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUzNTAzNjQsImV4cCI6MjA2MDkyNjM2NH0.3uafMgdT5Ie0DvzGyy2owt7lBK54BHLU7AfNY9n74mo", options, cookieOptions } = {}) {
...
/******/ var __webpack_exports__ = (__webpack_exec__(951));
